...
execute as @a at @s run scoreboard players operation @s Credits += @s run_complete_credit_bonus
execute as @a at @s run tellraw @s [{"text": "⌬ Credits ","color": "#76BDF8"},{"text":"+ ","color": "white"},{"text": "Finish Bonus ","color": "#39d03c"},{"text":"= ","color": "white"},{"score": {"objective": "Credits","name": "@s"}},{"text": " ⌬ Credits","color": "#76BDF8"}]
