scoreboard players remove @s[tag=!magus_meditating] magus_spell_tier_3 1
execute if score @s magus_spell_tier_3 matches ..-1 run scoreboard players set @s magus_spell_tier_3 5
