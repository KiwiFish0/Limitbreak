scoreboard players set @s spell_cost_current 250
...
execute unless score @s magus_mana_bar < @s spell_cost_current unless score @s magus_unstable_spell matches 1.. run function kiwi2:upgrades/classes/magus/spells/tier_1/fireball
