...
execute unless score @s magus_mana_bar < @s spell_cost_current run summon armor_stand ^ ^ ^5 {Marker:1b,Invisible:1b,Invulnerable:1b,Tags:["magus_lightning_bolt_marker"]}
...
execute unless score @s magus_mana_bar < @s spell_cost_current as @e[type=armor_stand,tag=magus_lightning_bolt_marker] at @s if block ~ ~-1 ~ #magus_lightning_spread run tp @s ~ ~-1 ~
execute unless score @s magus_mana_bar < @s spell_cost_current as @e[type=armor_stand,tag=magus_lightning_bolt_marker] at @s if block ~ ~-1 ~ #magus_lightning_spread run tp @s ~ ~-1 ~
execute unless score @s magus_mana_bar < @s spell_cost_current run title @s actionbar [{"text": "[LIGHTNING]","color": "#dff8ff","bold": true},{"text": " -","bold": false,"color": "red"},{"score": {"name": "@s","objective": "spell_cost_current"},"bold": false,"color": "red"},{"text": " Mana","bold": false,"color": "red"}]
...
execute unless score @s magus_mana_bar < @s spell_cost_current run schedule function kiwi2:upgrades/classes/magus/spells/tier_2/lightning_before_execute 10t append
execute unless score @s magus_mana_bar < @s spell_cost_current run schedule function kiwi2:upgrades/classes/magus/spells/tier_2/lightning_execute 17t append
