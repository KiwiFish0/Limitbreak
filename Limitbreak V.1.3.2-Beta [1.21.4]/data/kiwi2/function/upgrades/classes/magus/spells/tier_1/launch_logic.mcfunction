...
execute if entity @s[type=breeze_wind_charge] store result entity @s Motion[0] double 0.03 run scoreboard players operation .dx velocity -= .x velocity
execute if entity @s[type=breeze_wind_charge] store result entity @s Motion[1] double 0.03 run scoreboard players operation .dy velocity -= .y velocity
execute if entity @s[type=breeze_wind_charge] store result entity @s Motion[2] double 0.03 run scoreboard players operation .dz velocity -= .z velocity
